...
### Giriş  
Gizlilik politikamız, *Bir Derdim Var*'da hangi bilgileri topladığımızı, *Bir Derdim Var*'ın bu bilgileri nasıl kullandığını ve hangi seçeneklere sahip olduğunuzu anlamanıza yardımcı olacaktır.
*Efsunkar* ekibi olarak *Bir Derdim Var* uygulamasını ücretsiz bir uygulama olarak oluşturduk. Bu HİZMET *Efsunkar* ekibi tarafından ücretsiz olarak sağlanmaktadır ve olduğu gibi kullanılması amaçlanmıştır.
...
Uygulamamız herhangi bir veri toplamamaktadır.
Eğer uygulama içerisinden 'Bize Ulaşın' formunu doldurursanız aşağıdaki veriler veritabanımıza kaydedilecektir.
  - İp adresiniz
  - Email adresiniz
  - İsim, Soy isim bilgileriniz
  - Yazdığınız açıklama
...
### Cihaz Bilgileri
Google tarafından cihazınıza ait bazı bilgiler korsancılığa karşı toplanmaktadır.
...
İletişim Bilgileri:  
Email: *iletisim@birderdimvar.org*  
